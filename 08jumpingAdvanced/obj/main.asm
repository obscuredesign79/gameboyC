...
;--------------------------------------------------------
	.area _CODE
;main.c:17: void performantDelay(UINT8 numloops)
;	---------------------------------
; Function performantDelay
; ---------------------------------
_performantDelay::
;main.c:20: for(i=0;i < numloops;i++)
	ld	c,#0x00
00103$:
	ld	a,c
	ldhl	sp,#2
...
;main.c:20: for(i=0;i < numloops;i++)
	...
	jr	00103$
	ret
;main.c:40: void gameBallAnimRollLoop()//looping ball moving animation.(highlight jitters)
;	---------------------------------
; Function gameBallAnimRollLoop
; ---------------------------------
_gameBallAnimRollLoop::
;main.c:42: set_sprite_tile(1, 5);
	ld	hl,#0x0501
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:43: set_sprite_tile(2, 6);
	ld	hl,#0x0602
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:44: set_sprite_tile(3, 7);
	ld	hl,#0x0703
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:45: set_sprite_tile(4, 8);
	ld	hl,#0x0804
	push	hl
	call	_set_sprite_tile
	add	sp, #2
	ret
;main.c:48: void gameBallStaticStretched()//static ball stretch
;	---------------------------------
; Function gameBallStaticStretched
; ---------------------------------
_gameBallStaticStretched::
;main.c:50: set_sprite_tile(1, 9);
	ld	hl,#0x0901
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:51: set_sprite_tile(2, 10);
	ld	hl,#0x0a02
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:52: set_sprite_tile(3, 11);
	ld	hl,#0x0b03
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:53: set_sprite_tile(4, 12);
	ld	hl,#0x0c04
	push	hl
	call	_set_sprite_tile
	add	sp, #2
	ret
;main.c:56: void gameBallStaticRest()//static ball rest
;	---------------------------------
; Function gameBallStaticRest
; ---------------------------------
_gameBallStaticRest::
;main.c:58: set_sprite_tile(1, 1);
	ld	hl,#0x0101
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:59: set_sprite_tile(2, 2);
	ld	hl,#0x0202
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:60: set_sprite_tile(3, 3);
	ld	hl,#0x0303
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:61: set_sprite_tile(4, 4);
	ld	hl,#0x0404
	push	hl
	call	_set_sprite_tile
	add	sp, #2
	ret
;main.c:63: void gameBallAnimSquashed(UINT8 numloops)//static ball squashed
;	---------------------------------
...
00103$:
	...
	sub	a, (hl)
	jr	NC,00101$
;main.c:68: set_sprite_tile(1, 0);
	ld	hl,#0x0001
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:69: set_sprite_tile(2, 0);
	ld	hl,#0x0002
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:70: set_sprite_tile(3, 13);
	ld	hl,#0x0d03
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:71: set_sprite_tile(4, 14);
	ld	hl,#0x0e04
	push	hl
	call	_set_sprite_tile
	add	sp, #2
...
;main.c:83: move_sprite(character->spriteId[3],x + 8, y + 8);
	...
	add	sp, #4
	ret
;main.c:87: void setupBallSprite01()
;	---------------------------------
; Function setupBallSprite01
; ---------------------------------
_setupBallSprite01::
;main.c:89: set_sprite_data(0, 15, ballSprite);
	ld	hl,#_ballSprite
	push	hl
	ld	hl,#0x0f00
	push	hl
	...
	add	sp, #4
;main.c:91: ballSprite01.x=16;
	ld	hl,#(_ballSprite01 + 0x0004)
	ld	(hl),#0x10
;main.c:92: ballSprite01.y = floorYPosition;
	ld	de,#(_ballSprite01 + 0x0005)
	ld	hl,#_floorYPosition
	ld	a,(hl)
	ld	(de),a
;main.c:93: ballSprite01.width=16;
	ld	hl,#(_ballSprite01 + 0x0006)
	ld	(hl),#0x10
;main.c:94: ballSprite01.height=16;
	ld	hl,#(_ballSprite01 + 0x0007)
	ld	(hl),#0x10
;main.c:96: set_sprite_tile(1,1);
	ld	hl,#0x0101
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:97: ballSprite01.spriteId[0]=1;
	ld	hl,#_ballSprite01
	ld	(hl),#0x01
;main.c:98: set_sprite_tile(2,2);
	ld	hl,#0x0202
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:99: ballSprite01.spriteId[1]=2;
	ld	hl,#(_ballSprite01 + 0x0001)
	ld	(hl),#0x02
;main.c:100: set_sprite_tile(3,3);
	ld	hl,#0x0303
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:101: ballSprite01.spriteId[2]=3;
	ld	hl,#(_ballSprite01 + 0x0002)
	ld	(hl),#0x03
;main.c:102: set_sprite_tile(4,4);
	ld	hl,#0x0404
	push	hl
	call	_set_sprite_tile
	add	sp, #2
;main.c:103: ballSprite01.spriteId[3]=4;
	ld	hl,#(_ballSprite01 + 0x0003)
	ld	(hl),#0x04
;main.c:105: moveGameCharacter(&ballSprite01,ballSprite01.x,ballSprite01.y);
	...
	add	sp, #4
	ret
;main.c:108: INT8 wouldHitSurf(UINT8 projectedYPosition)
;	---------------------------------
; Function wouldHitSurf
; ---------------------------------
_wouldHitSurf::
;main.c:110: if(projectedYPosition >= floorYPosition){
	ldhl	sp,#2
	ld	a,(hl)
	ld	hl,#_floorYPosition
	sub	a, (hl)
	jr	C,00102$
;main.c:111: return floorYPosition;
	ld	e,(hl)
	ret
00102$:
;main.c:113: return -1;
	ld	e,#0xff
	ret
;main.c:117: void jump()
;	---------------------------------
; Function jump
; ---------------------------------
_jump::
;main.c:119: if(jumping == 0)
	ld	hl,#_jumping
	ld	a,(hl)
	or	a, a
	jr	NZ,00102$
;main.c:121: jumping = 1;
	ld	(hl),#0x01
;main.c:122: currentSpeedY = 10;
	ld	hl,#_currentSpeedY
	ld	(hl),#0x0a
00102$:
;main.c:124: currentSpeedY = currentSpeedY + gravity;
	ld	hl,#_currentSpeedY
	ld	c,(hl)
	ld	a,c
	ld	hl,#_gravity
	...
	ld	hl,#_currentSpeedY
	ld	(hl),a
;main.c:126: ballSprite01.y -= currentSpeedY;
	ld	de, #(_ballSprite01 + 0x0005) + 0
	ld	a,(de)
	ld	c,a
	sub	a, (hl)
	...
	ld	(hl),b
;main.c:128: possibleYSurface = wouldHitSurf(ballSprite01.y);
	push	bc
	inc	sp
	call	_wouldHitSurf
	inc	sp
	...
	ld	(hl),e
;main.c:134: moveGameCharacter(&ballSprite01,ballSprite01.x, possibleYSurface);
	ld	bc,#_ballSprite01 + 4
	ld	a,(bc)
	ld	b,a
;main.c:131: if(possibleYSurface == floorYPosition)
	ld	a,(hl)
	ld	hl,#_floorYPosition
	sub	a, (hl)
	jr	NZ,00104$
;main.c:133: jumping = 0;
	ld	hl,#_jumping
	ld	(hl),#0x00
;main.c:134: moveGameCharacter(&ballSprite01,ballSprite01.x, possibleYSurface);
	ld	hl,#_possibleYSurface
	...
	ret
00104$:
;main.c:139: moveGameCharacter(&ballSprite01,ballSprite01.x,ballSprite01.y);
	ld	de, #(_ballSprite01 + 0x0005) + 0
	ld	a,(de)
	ld	c,a
	push	af
...
; ---------------------------------
_main::
;main.c:145: setupBallSprite01();
	call	_setupBallSprite01
;main.c:148: jumping = 0;
	ld	hl,#_jumping
	ld	(hl),#0x00
;main.c:150: keyPressed_A = 1;
	ld	hl,#_keyPressed_A
	ld	(hl),#0x01
;main.c:153: DISPLAY_ON;
	ld	de,#0xff40
	ld	a,(de)
	ld	c,a
	ld	b,#0x00
...
;main.c:158: printf("%d", joypad());
	...
	call	_printf
	add	sp, #4
;main.c:160: if((joypad() & J_A || jumping == 1) && keyPressed_A == 1)
	call	_joypad
	ld	c,#0x00
	bit	4, e
	jr	NZ,00109$
...
;main.c:162: jump();	
	call	_jump
;main.c:163: gameBallStaticStretched();
	call	_gameBallStaticStretched
;main.c:164: if(jumping == 0)
	ld	hl,#_jumping
	ld	a,(hl)
	or	a, a
	jr	NZ,00107$
;main.c:166: gameBallAnimSquashed(500);
	ld	a,#0xf4
	push	af
	inc	sp
	call	_gameBallAnimSquashed
	inc	sp
;main.c:167: keyPressed_A = 0;
	ld	hl,#_keyPressed_A
	ld	(hl),#0x00
	jr	00107$
00106$:
;main.c:171: else if(joypad() != J_A)
	call	_joypad
	ld	a,e
	sub	a, #0x10
	jr	Z,00107$
;main.c:173: keyPressed_A = 1;
	ld	hl,#_keyPressed_A
	ld	(hl),#0x01
00107$:
;main.c:178: if((joypad() & J_RIGHT) && keyPressed_RIGHT == 1)
	call	_joypad
	ld	c,#0x00
	bit	0, e
	jp	Z,00115$
...
;main.c:181: ballSprite01.x += 3;
	...
	ld	hl,#(_ballSprite01 + 0x0004)
	ld	(hl),c
;main.c:182: moveGameCharacter(&ballSprite01, ballSprite01.x, ballSprite01.y);
	ld	de, #(_ballSprite01 + 0x0005) + 0
	ld	a,(de)
	ld	b,a
	push	bc
	...
	call	_moveGameCharacter
	add	sp, #4
;main.c:183: gameBallAnimRollLoop();
	call	_gameBallAnimRollLoop
;main.c:184: if(jumping == 0)
	ld	hl,#_jumping
	ld	a,(hl)
	or	a, a
	jr	NZ,00116$
;main.c:186: keyPressed_A = 1;
	ld	hl,#_keyPressed_A
	ld	(hl),#0x01
	jr	00116$
00115$:
;main.c:191: else if(joypad() != J_RIGHT)
	call	_joypad
	dec	e
	jr	Z,00116$
;main.c:193: keyPressed_RIGHT = 1;
	ld	hl,#_keyPressed_RIGHT
	ld	(hl),#0x01
00116$:
;main.c:196: performantDelay(2);
	ld	a,#0x02
	push	af
	inc	sp
